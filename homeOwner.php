                ...
                <div class="main-panel">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-10 mb-12 mb-lg-0stretch-card transparent">
                                <div class="card card-light-danger">
                                    <div class="card-body">
                                        <center><a class="fs-30 mb-3" href="laporan.php" style="text-decoration: none; color:white; "><b>LAPORAN</b></a></center>
                                    </div>
                                </div>
                                </div>
                            </div>
